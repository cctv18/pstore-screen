...
void pstore_screen_printk_snapshot_window(struct kmsg_dump_iter *iter);
...
static inline void pstore_screen_printk_snapshot_window(struct kmsg_dump_iter *iter)
{
}
